...
class ToolHead:
    def __init__(self, config):
        ...
        #take coord from module not object
    ...
    def set_position(self, newpos, homing_axes=""):
        ...
        logging.info("toolhead.set_position overwrote commanded_pos %s with %s"%(self.commanded_pos,newpos))
    ...
    def move(self, newpos, speed):
        ...
        logging.info("toolhead.move overwriting commanded_pos with %s"%(move.end_pos,))
    ...
    def add_extra_axis(self, ea, axis_pos):
        logging.info("add_extra_axis1 %s %s %s %s %s"%(ea, self.pos_axes, gcode.axis_map, axis_pos,self.Coord._fields))
        self._flush_lookahead()
    ...
    def _drip_load_trapq(self, submit_move):
        ...
        if submit_move.move_d:
            logging.info("toolhead._drip_load_trapq overwriting commanded_pos with %s"%submit_move.end_pos)
    ...
    def get_status(self, eventtime):
        ...
        res.update({ 'print_time': print_time,
                     ...
                     'position': gcode.Coord(*self.commanded_pos),
