...
class CoreXYKinematics:
    def __init__(self, toolhead, config):
        ...
        self.limits = [(1.0, -1.0)] * len(toolhead.Coord._fields)
        ranges = [r.get_range() for r in self.rails]
        self.axes_min = toolhead.Coord(*[r[0] for r in ranges]+self.limits[3:])
        self.axes_max = toolhead.Coord(*[r[1] for r in ranges]+self.limits[3:])
